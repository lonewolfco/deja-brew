...
let cityA = document.querySelector("#autocomplete-input").value;
...
let cities = []
    ...
    //filter null
var filtered = breweryAddress.filter(function (el) {
   return el != null;
   });
...
function generateBreweryData () {
    ...
    let cityB = document.querySelector("#autocomplete-input").value;
    let cityNospace = cityB.split(' ').join("%20");
    let brewRequestURL = "https://api.openbrewerydb.org/breweries?by_city=" + cityNospace;
